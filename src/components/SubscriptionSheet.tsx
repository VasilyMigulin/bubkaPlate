    ...
    <div className="article-view">
      ...
      <div className="sub-body">
        ...
        <ul className="tips-list">
          ...
          <li>Полный план первых 30 дней (неделя 1 — бесплатно)</li>
          <li>Новые статьи и материалы без ограничений</li>
        </ul>
        <div className="sub-free">Бесплатно навсегда: каталог всех продуктов с правилами подачи, основы прикорма, первая неделя плана 30 дней, дневник и вся безопасность. Это наша принципиальная позиция — безопасность не продаётся.</div>
