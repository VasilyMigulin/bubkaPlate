...
const SKILL_INFO: Record<string, string> = {
  ...
  'small6': 'В 6–8 месяцев малыш берёт еду всей ладошкой, поэтому мелкие кусочки сам взять пока не может. Предложите их с ложки, вмешайте в кашу или йогурт — либо помогите, вложив в ручку. К 8–9 месяцам появится пинцетный захват, и малыш начнёт брать кусочки двумя пальчиками сам.',
};
...
const SKILL_BY_LABEL: Record<string, string> = {
  ...
  'с 6 мес': '6',
  '6–12 мес': '6',
  'с 6 мес до 3–4 лет': 'small6',
  'с 6 мес до 4 лет': 'small6',
  'до 4 лет': 'small6',
};
