  ...
  return (
    <>
      ...
      <div className="note" style={{ marginTop: 14 }}>
        ...
        <span>Собрано по современным рекомендациям ВОЗ, AAP, NHS и данным исследований. Ориентир, а не замена консультации врача.</span>
      </div>
      ...
      {article && (
        <ArticleView article={article} onClose={() => setArticle(null)} footer={
